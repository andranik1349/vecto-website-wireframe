...
<!-- TOC:START — generated by tools/gen-ia-toc.py; do not edit by hand -->

- [Guiding principles](#guiding-principles)
- [Localization](#localization)
  - [Three languages, one structure](#three-languages-one-structure)
- [Primary navigation architecture](#primary-navigation-architecture)
  - [Top-level menu](#top-level-menu)
  - [Services megamenu — transformation-stage panel](#services-megamenu--transformation-stage-panel)
  - [Who We Serve megamenu — two-axis panel](#who-we-serve-megamenu--two-axis-panel)
  - [Our Work — direct link (no megamenu)](#our-work--direct-link-no-megamenu)
  - [How We Work megamenu — three-column panel](#how-we-work-megamenu--three-column-panel)
  - [Resources menu — simple dropdown](#resources-menu--simple-dropdown)
  - [About menu — simple dropdown](#about-menu--simple-dropdown)
  - [Get an Estimate — primary CTA](#get-an-estimate--primary-cta)
  - [Footer navigation](#footer-navigation)
- [Site structure — Homepage](#site-structure--homepage)
  - [Homepage · `/` · full](#homepage----full)
- [Site structure — Services](#site-structure--services)
  - [Services hub · `/services` · full](#services-hub--services--full)
  - [Sub-service page template · `/services/[category]/[sub-service]` · template](#sub-service-page-template--servicescategorysub-service--template)
  - [AI Transformation · `/services/ai-transformation` · full](#ai-transformation--servicesai-transformation--full)
  - [Software Development · `/services/software-development` · full](#software-development--servicessoftware-development--full)
  - [Product Design · `/services/product-design` · full](#product-design--servicesproduct-design--full)
  - [Marketing · `/services/marketing` · full](#marketing--servicesmarketing--full)
  - [IT Consulting · `/services/it-consulting` · full](#it-consulting--servicesit-consulting--full)
  - [Support & Maintenance · `/services/support-maintenance` · full](#support--maintenance--servicessupport-maintenance--full)
  - [Outsourcing & Outstaffing · `/services/outsourcing-outstaffing` · full](#outsourcing--outstaffing--servicesoutsourcing-outstaffing--full)
- [Site structure — Solutions](#site-structure--solutions)
  - [Solutions hub · `/solutions` · full · new](#solutions-hub--solutions--full--new)
  - [Solution page template · `/solutions/[solution-slug]` · template · new](#solution-page-template--solutionssolution-slug--template--new)
- [Site structure — Who We Serve](#site-structure--who-we-serve)
  - [Who We Serve hub · `/who-we-serve` · full](#who-we-serve-hub--who-we-serve--full)
  - [Company stage page template · `/who-we-serve/[stage]` · template](#company-stage-page-template--who-we-servestage--template)
...
- [Site structure — Resources / Blog](#site-structure--resources--blog)
  - [Resources / Blog hub · `/blog` *(also reachable as /resources)* · full](#resources--blog-hub--blog-also-reachable-as-resources--full)
  - [Blog post template · `/blog/[post-slug]` · mention](#blog-post-template--blogpost-slug--mention)
  - [Blog category page template · `/blog/category/[topic]` · mention · new](#blog-category-page-template--blogcategorytopic--mention--new)
  - [Author page template · `/blog/authors/[author-slug]` · mention](#author-page-template--blogauthorsauthor-slug--mention)
  - [Glossary hub · `/glossary` · full](#glossary-hub--glossary--full)
  - [Glossary entry template · `/glossary/[term]` · mention](#glossary-entry-template--glossaryterm--mention)
- [Site structure — About](#site-structure--about)
